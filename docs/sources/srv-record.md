...
You can create and manage SRV records with the help of [CRD source](crd.md)
...
In order to start managing SRV records you need to set the `--managed-record-types SRV` flag.
